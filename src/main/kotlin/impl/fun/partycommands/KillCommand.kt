...
class KillCommand : PartyCommand {
    ...
    override fun execute(sender: String, args: List<String>): String {
        ...
        val kill = listOf(
            ...
            "$user sat on $target's face for too long...", "Nuked $target.", "$target was choked by $user's thunderclappingly enormous thighs!", "$target slipped on a banana peel and exploded instantly.",
